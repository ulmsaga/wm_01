...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NttpocException.class)
    public ResponseEntity<ApiResponse<Void>> handleNttpocException(
            NttpocException e, HttpServletRequest request) {
        String message = messageSource.getMessage(
                e.getErrorCode().getMessageKey(), e.getArgs(), LocaleContextHolder.getLocale());
        log.warn("[NttpocException] uri={} code={} message={}",
